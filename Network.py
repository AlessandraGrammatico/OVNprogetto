...
class Network(object):
    ...
    def __init__(self, json_path, transceiver='fixed_rate'):
        ...
        # empty struct dict
        self.nodes = {} #dict[Node] - empty
        self.lines = {} #dict[Lines] - empty
    ...
    #availability of each channel - pandas dataframe
    @property
    ...
    #all the paths that connect the two nodes as list of node labels
    ...
    #best (highest) signal to noise ratio introduced by the signal propagation.
    ...
    #best (lowest) latency introduced by the signal propagation
    ...
    #propagate the signal information through the path specified in it and returns the modified spectral information + occupation(route_space)
    ...
    #  for each element of connections set the attribute latency or snr (latency by default) + path_occupation(route_space) + calculate_bit_rate
